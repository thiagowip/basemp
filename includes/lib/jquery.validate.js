 ...
 *
 * Copyright (c) 2006 - 2008 JA¶rn Zaefferer
 *
...
// constructor for validator
    ...
    $.extend($.validator, {
        ...
        messages: {
            ...
            maxlength: $.format("Por favor, forne&ccedil;a n&atilde;o mais que {0} caracteres."),
            minlength: $.format("Por favor, forne&ccedil;a ao menos {0} caracteres."),
            rangelength: $.format("Por favor, forne&ccedil;a um valor entre {0} e {1} caracteres de comprimento."),
            range: $.format("Por favor, forne&ccedil;a um valor entre {0} e {1}."),
            max: $.format("Por favor, forne&ccedil;a um valor menor ou igual a {0}."),
            min: $.format("Por favor, forne&ccedil;a um valor maior ou igual a {0}.")
        },
...
jQuery.validator.addMethod("dateBR", function (value, element) {
    ...
    return true;
}, "Informe uma data válida");  // Mensagem padrao 
 ...
 * A VALIDAÇAO É FEITA COM OU SEM OS CARACTERES SEPARADORES, PONTO, HIFEN, BARRA
 *
...
}, "Este valor nao pode ser igual"); // Mensagem padrao 
